defmodule KejaDigitalWeb.AdminLoginLive do
  ...
  def render(assigns) do
    ~H"""
    <div class="min-h-screen bg-gradient-to-r from-indigo-50 to-gray-50 flex flex-col justify-center py-12 px-6 lg:px-8">
          ...
          <.simple_form for={@form} id="login_form" action={~p"/admins/log_in"} phx-update="ignore" class="space-y-6">
            ...
            <div>
              <.button
                ...
                class="w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-lg text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition">
